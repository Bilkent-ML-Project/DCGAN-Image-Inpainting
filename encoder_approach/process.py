...
def process_directory(directory, square_size=20):
    ...
    os.makedirs(
        masks_dir, exist_ok=True
    )  # Create the processed directory if it doesn't exist
    os.makedirs(
        ims_dir, exist_ok=True
    )  # Create the processed directory if it doesn't exist
...
input_directory = "data/img_align_celeba/img_align_celeba/img_align_celeba"
