...
def load_dataset(root_dir, batch_size):
    ...
    subset_indices = torch.randperm(len(train_data))[:int(0.5 * len(train_data))]
    ...
    train_dataset, val_dataset, test_dataset = random_split(subset_dataset, [num_train, num_val, num_test])
