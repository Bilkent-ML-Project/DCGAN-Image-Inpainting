...
def impainting():
    ...
    for idx in range(num_batches):
        # for each batch of images, iterate impainting
        ...
        # prepare mask for input images
        # now only provide center mask
